...
def get_modalities(batch_size, shuffle, agent, _vision=True, _audio=True, _interoception=True):
    base_dir = 'dataset'
    vision_dir_male = os.path.join(base_dir, 'vision-au-txt1/Male')
    audio_dir_male = os.path.join(base_dir, 'audio-txt5/Male')
    interoception_dir_male = os.path.join(base_dir, 'interoception-txt101/Male')
    vision_dir_female = os.path.join(base_dir, 'vision-au-txt1/Female')
    audio_dir_female = os.path.join(base_dir, 'audio-txt5/Female')
    interoception_dir_female = os.path.join(base_dir, 'interoception-txt101/Female')
